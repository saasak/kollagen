...
<div class="space-y-8">
	...
	<section class="space-y-4">
		...
		<BrowserDemoCard
			...
			src="/previews/blocks/app-shell/side-and-top-navigation"
			height={760}
  ...
  <AppShell>
    ...
		...
		<BrowserDemoCard
			...
			src="/previews/blocks/app-shell/bottom-bar-on-mobile"
			height={420}
  ...
  <AppShell>...</AppShell>
		...
		<BrowserDemoCard
			...
			src="/previews/blocks/app-shell/standalone-top-bar"
			height={300}
			code={`<TopNavBar
  brand={brand}
  groups={groups}
